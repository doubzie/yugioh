...
public class PlayerHand extends JFrame {
	...
	public PlayerHand() {
		...
		setLocation(217,300);
		setResizable(false);
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); //to only close window & not the second interface also
		...
		panelMonsterControl.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		panelSpellControl.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
