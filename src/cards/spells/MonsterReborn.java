...
public class MonsterReborn extends SpellCard {
	...
	public void action(MonsterCard monster) {
		...
		if (!getBoard().getActivePlayer().getField().getGraveyard().isEmpty()
			...
			try {
				maxMonsterActive = (MonsterCard) getBoard().getActivePlayer().getField().getGraveyard()
						.get(maxIndexActive);
			...
			try {
				maxMonsterOpponent = (MonsterCard) getBoard().getOpponentPlayer().getField().getGraveyard()
