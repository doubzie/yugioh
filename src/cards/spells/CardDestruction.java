...
public class CardDestruction extends SpellCard {
	...
	public void action(MonsterCard monster) {
		...
		if (getBoard().getActivePlayer().getField().getDeck().getDeck().size() < getBoard().getActivePlayer().getField()
				.getHand().size()
				&& getBoard().getOpponentPlayer().getField().getDeck().getDeck().size() < getBoard().getOpponentPlayer()
						.getField().getHand().size()) {
			...
			if (numberOfCards != 0) {
				getBoard().getActivePlayer().getField()
						.removeCardToGraveyard(getBoard().getActivePlayer().getField().getHand());
			...
			if (getBoard().getWinner() == null) {
				...
				if (numberOfCards2 != 0)
					getBoard().getOpponentPlayer().getField()
							.removeCardToGraveyard(getBoard().getOpponentPlayer().getField().getHand());
