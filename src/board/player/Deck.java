...
public class Deck {
	...
	public ArrayList<Card> loadCardsFromFile(String path) throws IOException, UnexpectedFormatException {
		...
		for (int i = 0; i < cardsStringArray.size(); i++) {
			...
			if (cardStringElement[0].equals("Monster")) {
				cardsArray.add(new MonsterCard(cardStringElement[1], cardStringElement[2],
						Integer.parseInt(cardStringElement[5]), Integer.parseInt(cardStringElement[3]),
				...
				if (hasMonstersLoaded)
					if (!cardStringElement[1].equals("Card Destruction")
							...
							&& !cardStringElement[1].equals("Heavy Storm") && !cardStringElement[1].equals("Mage Power")
							&& !cardStringElement[1].equals("Monster Reborn")
							&& !cardStringElement[1].equals("Pot of Greed") && !cardStringElement[1].equals("Raigeki"))
	...
	public static MonsterCard cloneMonsterCard(Card c) {
		...
		return new MonsterCard(m.getName(), m.getDescription(), m.getLevel(), m.getAttackPoints(),
				m.getDefensePoints());
	}
