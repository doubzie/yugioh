...
public class Controller implements ActionListener, WindowListener {
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() instanceof ButtonDuelMode) {
      ...
      try {
        if (
          ...
          new Player(
            gui.getStartWindow().getTxtFldPlayer1().getText()
          ); else p1 = new Player("Yugi");
        ...
        if (
          ...
          new Player(
            gui.getStartWindow().getTxtFldPlayer2().getText()
          ); else p2 = new Player("Kaiba");
      ...
      if (
        board.getActivePlayer().getName() == p1.getName()
      ) disable2Enable1(); else disable1Enable2();
    }

    if (e.getSource() instanceof ButtonQuitGame) System.exit(0);

    if (e.getSource() instanceof ButtonNextPhase) {
      if (
        board.getActivePlayer().getName() ==
        gui.getGameWindow().getLblPlayer1Name().getText()
      ) {
        ...
        if (
          board.getActivePlayer().getName() ==
          gui.getGameWindow().getLblPlayer2Name().getText()
        ) {
          if (board.getActivePlayer().getField().getPhase() != Phase.MAIN2) {
            board.getActivePlayer().endPhase();
            gui
    ...
    if (e.getActionCommand().equals("Hand")) {
      ...
      if (
        board.getActivePlayer().getName() ==
        gui.getGameWindow().getLblPlayer1Name().getText()
      ) gui.getHandPlayer1().setVisible(true); else gui
        .getHandPlayer2()
        .setVisible(true);
    }
      ...
      if (e.getSource() instanceof ButtonHand) {
        ...
        if (e.getSource() instanceof ButtonSpell) {
          ...
          if (
            ...
            index =
              gui.getGameWindow().getArrayPlayer1Spells().indexOf(firstClick);

            try {
              spell =
                board.getActivePlayer().getField().getSpellArea().get(index);
            } catch (ArrayIndexOutOfBoundsException c) {
              nullifyAttributes();
            }

            if (
              !(spell instanceof MagePower || spell instanceof ChangeOfHeart)
            ) {
              try {
            ...
            index =
              gui.getGameWindow().getArrayPlayer2Spells().indexOf(firstClick);
            ...
            if (
              ...
              if (
                ...
                if (dialogResult == JOptionPane.YES_OPTION) {
                  ...
                  if (!opSuccessful) JOptionPane.showMessageDialog(
                    null,
          ...
          if (secondClick.getActionCommand().equals("Summon Monster")) {
            if (monster.getLevel() <= 4) {
              try {
                ...
                JOptionPane.showMessageDialog(
                  null,
                  "You cannot summon a monster in the battle phase"
                );
              ...
              if (monster.getLevel() == 5 || monster.getLevel() == 6) {
                if (
                  ...
                  JOptionPane.showMessageDialog(
                    null,
                    "Not enough sacrifices in field"
                  );
                  nullifyAttributes();
                }
              } else {
            ...
            if (secondClick.getActionCommand().equals("Set Monster")) {
              if (monster.getLevel() <= 4) {
                try {
                  ...
                  JOptionPane.showMessageDialog(
                    null,
                    "You cannot set a monster in the battle phase"
                  );
                } catch (MultipleMonsterAdditionException c) {
                  JOptionPane.showMessageDialog(
                    null,
                ...
                if (monster.getLevel() == 5 || monster.getLevel() == 6) {
                  ...
                  if (monster.getLevel() == 7 || monster.getLevel() == 8) if (
                    board
                      .getActivePlayer()
                      .getField()
                      .getMonstersArea()
              ...
              if (secondClick.getActionCommand().equals("Set Spell")) {
                try {
                  ...
                  JOptionPane.showMessageDialog(
                    null,
                    "There is no space in the spells area"
                  );
                } catch (WrongPhaseException c) {
                  JOptionPane.showMessageDialog(
                    null,
                ...
                if (secondClick.getActionCommand().equals("Activate Spell")) {
                  if (
                    !(
                      spell instanceof ChangeOfHeart ||
                      ...
                      if (spell instanceof ChangeOfHeart) {
                        ...
                        if (
                          ...
                          gui
                            .getGameWindow()
                            .getArrayPlayer2Monsters()
                            .indexOf(secondClick); else index =
                          gui
                            .getGameWindow()
                            .getArrayPlayer1Monsters()
                            .indexOf(secondClick);

                        if (index == -1) secondClick = null; else {
                          monsterSpelled =
                            board
                              .getOpponentPlayer()
                              .getField()
                          ...
                          try {
                            board
                              .getActivePlayer()
                              .activateSpell(spell, monsterSpelled);
                          } catch (WrongPhaseException c) {
                            JOptionPane.showMessageDialog(
                              null,
                              "You cannot activate this spell in the battle phase"
                      ...
                      if (e.getSource() instanceof ButtonMonster) {
                        ...
                        if (index != -1) {
                          ...
                          try {
                            board
                              .getActivePlayer()
                              .declareAttack(monster, monsterAtt);
                          } catch (MonsterMultipleAttackException c) {
                            JOptionPane.showMessageDialog(
                              null,
                              "You already attacked with this monster"
            ...
            if (thirdClick == null) {
              if (e.getSource() instanceof ButtonMonster) {
                ...
                try {
                  ...
                  JOptionPane.showMessageDialog(
                    null,
                    "You cannot summon in the battle phase"
                  );
                } catch (MultipleMonsterAdditionException c) {
                  JOptionPane.showMessageDialog(
                    null,
                ...
                if (e.getSource() instanceof ButtonMonster) {
                  ...
                  if (
                    ...
                    gui
                      .getGameWindow()
                      .getArrayPlayer1Monsters()
                      .indexOf(fourthClick); else index =
                    gui
                      .getGameWindow()
                      .getArrayPlayer2Monsters()
                      .indexOf(fourthClick);
              ...
              if (thirdClick == null) {
                if (e.getSource() instanceof ButtonMonster) {
                  ...
                  try {
                    ...
                    JOptionPane.showMessageDialog(
                      null,
                      "You cannot set in the battle phase"
                    );
                  } catch (MultipleMonsterAdditionException c) {
                    JOptionPane.showMessageDialog(
                      null,
              ...
              if (thirdClick == null) {
                if (e.getSource() instanceof ButtonMonster) {
                  ...
                  if (spell instanceof ChangeOfHeart) {
                    ...
                    if (index == -1) thirdClick = null; else {
                      monsterSpelled =
                        board
                          .getOpponentPlayer()
                          .getField()
    ...
    if (
      ...
      gui
        .getGameWindow()
        .getLblPlayer1LifePoints()
        .setText("" + (board.getActivePlayer().getLifePoints()));
      gui
        .getGameWindow()
        .getLblPlayer2LifePoints()
        .setText("" + (board.getOpponentPlayer().getLifePoints()));
      gui
        .getGameWindow()
        .getLblPlayer1DeckCount()
        .setText(
          "" + board.getActivePlayer().getField().getDeck().getDeck().size()
        );
      gui
        .getGameWindow()
        .getLblPlayer2DeckCount()
        .setText(
          "" + board.getOpponentPlayer().getField().getDeck().getDeck().size()
        );

      gui
        .getGameWindow()
        .getProgressBarPlayer2()
        .setValue(
          Integer.parseInt(
            gui.getGameWindow().getLblPlayer2LifePoints().getText()
          )
        );
      gui
        .getGameWindow()
        .getProgressBarPlayer1()
        .setValue(
          Integer.parseInt(
            gui.getGameWindow().getLblPlayer1LifePoints().getText()
          )
        );

      if (board.getActivePlayer().getField().getGraveyard().size() == 0) gui
        .getGameWindow()
        .getBtnPlayer1Graveyard()
        .setIcon(getImageIcon("/resources/CardBack.png")); else {
        Card card = board
          .getActivePlayer()
          .getField()
          .getGraveyard()
        ...
        if (card instanceof MonsterCard) text =
          ((MonsterCard) card).toString(); else text =
          ((SpellCard) card).toString();
      ...
      if (board.getOpponentPlayer().getField().getGraveyard().size() == 0) gui
        .getGameWindow()
        .getBtnPlayer2Graveyard()
        .setIcon(getImageIcon("/resources/CardBack.png")); else {
        Card card = board
          .getOpponentPlayer()
          .getField()
      ...
      for (
        int i = 0;
        i < board.getActivePlayer().getField().getMonstersArea().size();
        i++
      ) {
        String cardName = board
          .getActivePlayer()
          .getField()
          .getMonstersArea()
          .get(i)
          .getName();
        MonsterCard card = board
          .getActivePlayer()
          .getField()
          .getMonstersArea()
          .get(i);
        ...
        if (card.getMode() == Mode.DEFENSE) gui
          .getGameWindow()
          .getArrayPlayer1Monsters()
          .get(i)
          .setIcon(getImageIcon("/resources/CardBack.png")); else gui
          .getGameWindow()
          .getArrayPlayer1Monsters()
          .get(i)
      ...
      for (
        int i = 0;
        i < board.getOpponentPlayer().getField().getMonstersArea().size();
        i++
      ) {
        String cardName = board
          .getOpponentPlayer()
      ...
      for (
        int i = 0;
        i < board.getActivePlayer().getField().getSpellArea().size();
        i++
      ) {
        gui
          .getGameWindow()
          .getArrayPlayer1Spells()
          .get(i)
          .setIcon(getImageIcon("/resources/CardBack.png"));
        gui.getGameWindow().getArrayPlayer1Spells().get(i).setEnabled(true);

        String text = "";
        SpellCard card = board
          .getActivePlayer()
          .getField()
          .getSpellArea()
          .get(i);
      ...
      for (
        int i = 0;
        i < board.getOpponentPlayer().getField().getSpellArea().size();
        i++
      ) {
        gui
          .getGameWindow()
          .getArrayPlayer2Spells()
          .get(i)
          .setIcon(getImageIcon("/resources/CardBack.png"));
      ...
      for (
        int i = 0;
        i < board.getActivePlayer().getField().getSpellArea().size() && i < 5;
        i++
      ) {
        gui
          .getGameWindow()
      ...
      for (
        int i = 0;
        i < board.getOpponentPlayer().getField().getSpellArea().size() && i < 5;
        i++
      ) {
        gui
          .getGameWindow()
    ...
    if (e.getSource() instanceof ButtonDeck) {
      ...
      if (dialogResult == JOptionPane.YES_OPTION) {
        ...
        if (tempBtn.getToolTipText().equals("Player 1 Deck")) gui
          .getEndWindow()
          .setTitle(
            gui.getGameWindow().getLblPlayer2Name().getText() + " wins!"
          ); else gui
          .getEndWindow()
          .setTitle(
            gui.getGameWindow().getLblPlayer1Name().getText() + " wins!"
          );
  ...
  public void updateHand() {
    if (
      ...
      for (
        int i = 0;
        i < board.getActivePlayer().getField().getHand().size();
        i++
      ) {
        String cardName = board
          .getActivePlayer()
  ...
  public void addActionListenersToButtons() {
    ...
    ArrayList<ButtonMonster> monsterButtons1 = gui
      .getGameWindow()
      .getArrayPlayer1Monsters();
    for (ButtonMonster monsterbutton : monsterButtons1) monsterbutton.addActionListener(
      this
    );

    ArrayList<ButtonMonster> monsterButtons2 = gui
      .getGameWindow()
      .getArrayPlayer2Monsters();
    for (ButtonMonster monsterbutton : monsterButtons2) monsterbutton.addActionListener(
      this
    );

    ArrayList<ButtonSpell> spellButtons1 = gui
      .getGameWindow()
      .getArrayPlayer1Spells();
    for (ButtonSpell spellbutton : spellButtons1) spellbutton.addActionListener(
      this
    );

    ArrayList<ButtonSpell> spellButtons2 = gui
      .getGameWindow()
      .getArrayPlayer2Spells();
    for (ButtonSpell spellbutton : spellButtons2) spellbutton.addActionListener(
      this
    );
    ...
    for (ButtonHand handbutton : handButtons1) handbutton.addActionListener(
      this
    );

    ArrayList<ButtonHand> handButtons2 = gui.getHandPlayer2().getArrayCards();
    for (ButtonHand handbutton : handButtons2) handbutton.addActionListener(
      this
    );
  ...
  public void windowClosed(WindowEvent e) {
    if (e.getSource() instanceof PlayerHand) nullifyAttributes();
  }
